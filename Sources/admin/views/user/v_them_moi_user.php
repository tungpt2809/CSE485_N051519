    ...
    <form action="user.php" method="POST" class="row" id="new-user-form">
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <input name="phone_number" id="phone_number" type="text" class="form-control"  autocomplete="off" placeholder="Số điện thoại">
            </div>
            <div class="form-group">
                <label>Địa chỉ :</label>            
        ...
        <input type="submit" value="Thêm" form="new-user-form" name="btn_add" id="new-user-btn" class="btn btn-primary">
    </form>
</div>